...
<div class="cztable">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
				<input type="text" value="${exam.examId}" readonly/>
			</td>
        </tr>
        ...
        <tr>
            ...
            <td>
				<input type="text" value="${exam.examNo}" readonly"/>
			</td>
        </tr>
        ...
        <tr>
            ...
            <td>
				<input type="text"  value="${exam.examSubject}" readonly/>
			</td>
        </tr>
		...
		<tr>
            ...
            <td>
				<input type="text"  value="${exam.examTime}" readonly/>
			</td>
        </tr>
		...
		<tr>
            ...
            <td>
				<input type="text" value="${exam.examCount}" readonly />
			</td>
        </tr>
		...
		<tr>
            ...
            <td>
				<input type="text" value="${exam.examState}" readonly />
			</td>
        </tr>
