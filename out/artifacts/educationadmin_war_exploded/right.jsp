    ...
    <body>
            ...
            <tr height=100>
                ...
                <td>
                    <table height=100 cellspacing=0 cellpadding=0 width="100%" border=0>
                        ...
                        <tr>
                            <td style="font-weight: bold; font-size: 16px">${thisuser.account}</td>
						</tr>
                        <tr>
        ...
        <table cellspacing=0 cellpadding=2 width="95%" align=center border=0>
            <tr>
                ...
                <td style="color: #880000">${thisuser.account}</td></tr>
            <tr>
                <td align=right>真实姓名：</td>
                <td style="color: #880000">${thisuser.username}</td></tr>
            <tr>
...
<p>维护信息：<a href="http://www.zparkedu.com" target="_blank">中软高科（北京）科技有限公司</a></p>
