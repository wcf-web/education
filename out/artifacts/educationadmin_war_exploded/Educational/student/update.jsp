...
<div class="cztable">
    <form action="/updatestudent" method="post">
        <input type="hidden" value="${stu.studentId}" name="stuid"/>
	<table border="1" width="100%" class="table_a">
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<input type="text"  name="studentName" value="${stu.studentName}"/>
					</td>
                </tr>
               <tr>
                    ...
                    <td>
                        <select id="sid" name="college">
                            ...
                            <c:forEach items="${collegeList}" var="list">
                                 <option value="${list.collegeId}" ${list.collegeId==stu.collegeId?"selected":""}>${list.collegeName}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
				...
				<tr>
                    <td>户口所在地：</td>
                    <td>
                        <input type="text" name="register" value="${stu.register}"/>
                    </td>                
                </tr>
				...
				<tr>
                    <td>身份证号：</td>
                    <td>
                        <input type="text" name="idCard" value="${stu.idCard}"/>
                    </td>                
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <textarea name="content" >${stu.content}</textarea>
                    </td>
                </tr>
				<tr>
