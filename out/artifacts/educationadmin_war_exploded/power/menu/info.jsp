...
<table border="1" width="100%" class="table_a">
				...
				<tr  width="120px;">
                    ...
                    <td>
                        <input type="text"  name="f_goods_image" value="${menu.parentName}" />
					</td>
                </tr>
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<input type="text"  name="f_goods_image" value="${menu.utl}" />
					</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="state" value="1" ${menu.menuStatus==1?"checked":""}/>启用
                        <input type="radio" name="state" value="0" ${menu.menuStatus==0?"checked":""}/>禁用
                    </td>
                </tr>
                ...
                <tr  width="120px;">
                    ...
                    <td>
						<textarea rows="5" cols="20">${menu.content}</textarea>
					</td>
                </tr>
