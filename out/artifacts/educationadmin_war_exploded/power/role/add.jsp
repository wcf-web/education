                ...
                <tr  width="120px;">
                    ...
                    <td>
						<ul>
                            ...
                            <c:forEach items="${mlist}" var="list1">
                                <c:if test="${list1.parentId==0}">
                                    <li><input type="checkbox" name="menu" value="${list1.menuId}" />${list1.menuName}
                                        <ul>
                                            <c:forEach items="${mlist}" var="list2">
                                              <c:if test="${list2.parentId==list1.menuId}">
                                                  <li>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu"  value="${list2.menuId}"/>${list2.menuName}</li>
                                              </c:if>
                                            </c:forEach>
                                        </ul>
                                    </li>
